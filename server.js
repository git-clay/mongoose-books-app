...
// require models directory (contains BookSchema in book.js >> index.js)
...
//  DATA
///////////////////
// hard coded books not needed since we will be using the db to save and access
// var books = [
//   {
//     _id: 15,
...
app.get('/api/books/:id', function (req, res) {
  ...
  db.Book.findOne({"_id":req.params._id}, function(err,book){
